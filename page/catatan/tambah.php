...
// $catatan = query("SELECT anggaran.nama_anggaran, kategori.nama_kategori FROM anggaran JOIN kategori WHERE anggaran.id_anggaran AND kategori.id_kategori");
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div class="card-container mt-2 p-5 bg-body rounded">
          <h4 class="text-center"><strong>Tambah Data Catatan Pengeluaran</strong></h4>
				  <hr>
          <br>
				  <div class="card-body">
            <form action="" method="post">
                <div class="mb-3 card-title">
                    ...
                    <input type="date" class="form-control" id="tgl_catatan" name="tgl_catatan">
                </div>
                <div class="mb-3 card-title">
                    <label>Nominal</label>
