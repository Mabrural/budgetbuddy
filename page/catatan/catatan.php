...
$catatan = query("SELECT catatan_pengeluaran.tgl_catatan, catatan_pengeluaran.nominal, anggaran.nama_anggaran, kategori.nama_kategori, catatan_pengeluaran.keterangan FROM catatan_pengeluaran JOIN anggaran JOIN kategori WHERE catatan_pengeluaran.id_kategori = kategori.id_kategori AND catatan_pengeluaran.id_anggaran = anggaran.id_anggaran");
?>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <h4 class="text-center"><strong>Pencatatan Pengeluaran</strong></h4>
				<hr>
        ...
        <br>
            ...
            <?php foreach($catatan as $row) : ?>
						<tr>
              <td><?= $i; ?></td>
              <td><?= $row['tgl_catatan'];?></td>
              <td><?= $row['nominal'];?></td>
              <td><?= $row['nama_anggaran'];?></td>
              <td><?= $row['nama_kategori'];?></td>
              <td><?= $row['keterangan'];?></td>
              <td><a href="ubah.php"><button class="btn btn-warning btn-sm"><i class="fas fa-edit fa-sm"></i> Ubah</button></a></td>
              <td><a href="hapus.php"><button class="btn btn-danger btn-sm"><i class="fas fa-trash fa-sm"></i> Hapus</button></a></td>
            </tr>
            <?php $i++; ?>
            <?php endforeach;?>
