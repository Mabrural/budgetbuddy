...
$tagihan = query("SELECT * FROM tagihan ORDER BY id_tagihan ASC");
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <h4 class="text-center"><strong>Data Tagihan</strong></h4>
				<hr>
        ...
        <br>
            ...
            <?php foreach ($tagihan as $row) : ?>
              ...
              <td><?= $row['nominal'];?></td>
              <td><?= $row['tgl_due'];?></td>
              <td><a href="ubah.php?id_tagihan=<?= $row["id_tagihan"];?>"><button class="btn btn-warning btn-sm"><i class="fas fa-edit fa-sm"></i> Ubah</button></a></td>
              <td><a href="hapus.php?id_tagihan=<?= $row["id_tagihan"]; ?>" onclick="return confirm('yakin?');""><button class="btn btn-danger btn-sm"><i class="fas fa-trash fa-sm"></i> Hapus</button></a></td>
            </tr>
            <?php $i++;?>
            <?php endforeach; ?>
