...
$tagihan = query("SELECT * FROM tagihan WHERE id_tagihan = $id")[0];
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <h4 class="text-center"><strong>Ubah Data Tagihan</strong></h4>
			<hr>
            <br>
			<div class="card-body">
              ...
              <input type="hidden" name="id_tagihan"  value="<?= $tagihan["id_tagihan"];?>">
                ...
                <div class="mb-3 card-title">
                    <label>Nominal</label>
                    <input type="text" class="form-control" id="nominal" name="nominal" value="<?= $tagihan["nominal"];?>" required>
                </div>
                <div class="mb-3 card-title">
                    <label>Tanggal Jatuh Tempo</label>
                    <input type="date" class="form-control" id="tgl_due" name="tgl_due" value="<?= $tagihan["tgl_due"];?>" required>
                </div>
                <br>
