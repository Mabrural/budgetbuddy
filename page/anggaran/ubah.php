...
$anggaran = query("SELECT * FROM anggaran WHERE id_anggaran = $id")[0];
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <h4 class="text-center"><strong>Ubah Data Anggaran</strong></h4>
				<hr>
             <br>
			<div class="card-body">
              ...
              <input type="hidden" name="id_anggaran"  value="<?= $anggaran["id_anggaran"];?>">
                <div class="mb-3 card-title">
                    ...
                    <input type="text" class="form-control" id="nama_anggaran" name="nama_anggaran" value="<?= $anggaran["nama_anggaran"];?>" required>
                </div>
                <div class="mb-3 card-title">
                    <label>Nominal</label>
                    <input type="text" class="form-control" id="nominal" name="nominal" value="<?= $anggaran["nominal"];?>" required>
                </div>
                <div class="mb-3 card-title">
                    <label>Tanggal Mulai</label>
                    <input type="date" class="form-control" id="tgl_mulai" name="tgl_mulai" value="<?= $anggaran["tgl_mulai"];?>" required>
                </div>
                <div class="mb-3 card-title">
                    <label>Tanggal Selesai</label>
                    <input type="date" class="form-control" id="tgl_akhir" name="tgl_akhir" value="<?= $anggaran["tgl_akhir"];?>" required>
                </div>
                <br>
